...
namespace AppMVC.Controllers
{
    ...
    {
        public IManejadorIluminacion ManejadorIluminacion { get; set; }
        public IManejadorPlanta ManejadorPlanta { get; set; }
        public IWebHostEnvironment WebHostEnvironment { get; set; }

        public PlantasController(IManejadorPlanta manejador, IWebHostEnvironment whenv, IManejadorIluminacion iluminacion)
        {
            ManejadorPlanta = manejador;
            WebHostEnvironment = whenv;
            ManejadorIluminacion = iluminacion;
        }
        ...
        public ActionResult Create()
        {
            ...
            else
            {
               ...
               vmPlanta.ListaTipos = ManejadorPlanta.TraerTodosLosTipos(); //deberia ir por manejador de tipo de plantas
               vmPlanta.ListaIluminacion = ManejadorIluminacion.TraerTodasLasIluminaciones(); 
